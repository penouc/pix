...
export function TitleBar({ left, right }: { left?: ReactNode; right?: ReactNode }) {
  return (
    <div className="relative flex h-9 flex-none items-center gap-2 bg-surface px-3" style={drag}>
      <div className="w-[70px] flex-none" />
      <div className="absolute left-[76px] flex items-center" style={noDrag}>
        {left}
      </div>
